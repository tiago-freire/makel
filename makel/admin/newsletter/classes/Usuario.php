...
class Usuario {
	...
	function save()
	{
		...
		{
			//add
			$query = mysql_query("INSERT INTO " . Usuario::$table . "(user_nome,user_login,user_senha,user_perms,user_admin,user_cliente) VALUES('$this->nome','$this->login','$this->senha','$this->perms','$this->admin','$this->cliente') ") or die(mysql_error());
		...
		else
		{
			...
			$query = mysql_query("UPDATE " . Usuario::$table . " SET user_nome='$this->nome',user_login='$this->login',user_perms='$this->perms',user_cliente='$this->cliente' WHERE user_id='$this->id' ") or die(mysql_error());
		}
	}
